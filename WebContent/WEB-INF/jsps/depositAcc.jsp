...
<%@ include file="header.jsp" %>
	...
	<div class="col-md-6 col-md-offset-3">
		<sf:form class="form-horizontal"
			action="${pageContext.request.contextPath}/okDeposit" method="post"
			commandName="depositMoney">
			<fieldset>

				<!-- Form Name -->
				<legend>Deposit Money To Your Account</legend>
<h4 class="text-danger">
			...
			<div class="form-group">
				<label class="col-md-4 control-label" for="account_No">Account
					No:</label>
				<div class="col-md-4">
					<sf:input id="account_No" path="account_No" name="account_No" 

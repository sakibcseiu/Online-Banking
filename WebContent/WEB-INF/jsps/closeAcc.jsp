...
<%@ include file="header.jsp" %>
	...
	<div class="col-md-6 col-md-offset-3">
		<sf:form class="form-horizontal"
			action="${pageContext.request.contextPath}/okClose" method="post"
			commandName="closeAccount">
			<fieldset>

				<!-- Form Name -->
				<legend>Close Your Account</legend>
...
<sf:errors path="account_No" cssClass="alert-danger"></sf:errors>
				...
				<div class="form-group">
					...
					<div class="col-md-4">
						<button id="submit" name="submit" class="btn btn-primary">Close</button>
					</div>
				</div>

...
<%@ include file="header.jsp" %>
	...
	<div class="col-md-6 col-md-offset-3">
		<sf:form class="form-horizontal"
			action="${pageContext.request.contextPath}/okwithdraw" method="post"
			commandName="withdrawMoney">
			<fieldset>

				<!-- Form Name -->
				<legend>Withdraw Money From Your Account</legend>
...
<sf:errors path="account_No" cssClass="alert-danger"></sf:errors>
				...
				<div class="form-group">
					...
					<div class="col-md-4">
						<button id="submit" name="submit" class="btn btn-primary">Withdraw</button>
					</div>
				</div>
